...
ExceptionsData.FunctionsEvaluation.msg1 = 'Wrong input data, provide a valid string as the first input argument to indicate the form of the requested evaluation points. The argument can be omitted, so that the default option is selected. Valid options are: ''RepetitiveUniformInSpans''(default), ''RepetitiveGivenInSpans'', ''ArbitraryGivenInSpans'', ''ArbitraryGivenInDomain''.';
ExceptionsData.FunctionsEvaluation.msg2 = 'Wrong input data, provide an appropriate type of data as the second input argument to indicate the requested evaluation points. The argument can be omitted, so that the default values to be used. Valid options are: ''RepetitiveUniformInSpans'' -> a scalar number, ''RepetitiveGivenInSpans'' -> a single dimensional array, ''ArbitraryGivenInSpans'' -> a single dimensional cell with single dimensional arrays, where the first element in each array indicates the knot span number, ''ArbitraryGivenInDomain'' -> a single dimensional array';
